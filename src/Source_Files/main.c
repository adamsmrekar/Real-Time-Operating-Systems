 ...
 * @file: main.c
 * @brief: Simulated vehicle control system using MicriumOS,programmed on 
 *         a EFM32 Pearl Gecko. Utilizes Pearl Gecko's Capacitive touch
 *         slider, push buttons, LEDs, and LCD Display. These features
 *         are integrated using tasks and inter-task communication.
 *******************************************************************************
 * # License
